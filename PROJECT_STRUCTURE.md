...
M2 Channel Growth Foundation 已冻结为 v1.0。当前平台进入 M3 Website Platform Foundation，已完成 M3.0 Database Architecture、M3.1 Authentication & Authorization、M3.2 CMS Architecture、M3.3 Media Management Architecture 与 M3.4 Lead Center Architecture 架构冻结。
