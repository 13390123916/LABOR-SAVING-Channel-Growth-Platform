...
for (const token of ["Platform Architecture", "Single Source of Truth", "Platform Module Intake Gate", "Platform Capability", "Platform Module 归属", "PLATFORM_ARCHITECTURE.md 统一管理", "Governance Note", "不属于新的 Platform Capability", "不允许重新排列 Milestone", "Platform Evolution Principle", "Freeze First, Runtime Later", "Runtime Implementation", "Platform Stability Rules", "Freeze Architecture", "Freeze Governance", "Freeze Module Ownership", "Runtime Follows Architecture", "No Runtime-Driven Architecture Changes", "Roadmap Freeze Rule", "Runtime Development", "Platform Development", "Website", "Content", "SEO / GEO", "Dealer Center", "Analytics", "Security / Permission", "Platform Freeze Review", "Platform Runtime", "Database", "Authentication", "CMS", "Media", "Lead Center", "Platform Assets", "模块职责", "模块依赖", "平台生命周期", "M3 阶段边界", "ADR 治理规则", "Media Management Architecture", "Lead Center Architecture", "Platform Assets Architecture", "Dealer 是渠道增长核心对象", "Analytics 是归因与转化复盘层", "Organization Schema", "Brand Entity", "ContactPoint", "Download Resource", "M4 Platform Runtime", "README.md", "docs/ROADMAP.md", "docs/adr/README.md"]) {
