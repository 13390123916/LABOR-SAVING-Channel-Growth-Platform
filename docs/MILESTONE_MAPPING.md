...
| M3.6 SEO Runtime Architecture | sitemap、robots、canonical、redirect、RSS、IndexNow 与站长平台接入边界 |
| M3.7 GEO Runtime Architecture | AI Search Feed、FAQ 摘要、实体知识包和国内 AI 搜索引用资产边界 |
| M3.8 Audit Center / Backup & Restore Architecture | 操作日志、审计查询、审计归档、合规导出、高风险动作追踪、数据备份、恢复、版本回滚、灾备和批量归档边界 |
